...
export default class RejectRuleId extends Command {
  static override description =
    'Reject rule in an application of a ruleGraph contract'
  ...
  public async run(): Promise<void> {
    const { flags } = await this.parse(RejectRuleId)
    ...
    try {
      ...
      this.log('Rule ID ' + flags.ruleId + ' rejected successfully\n')
